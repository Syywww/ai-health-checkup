...
public class AiChatServiceImpl implements IAiChatService
{
     ...
     */
    @Override
    public List<com.health.system.domain.AiMessage> listMessages(Long conversationId, Long userId)
    {
    ...
    public void chat(Long conversationId, String userInput, Long userId, SseEmitter emitter)
    {
        ...
        com.health.system.domain.AiMessage userMsg = new com.health.system.domain.AiMessage();
        ...
        streamingModel.generate(messages, new StreamingResponseHandler<AiMessage>()
        {
            ...
            public void onComplete(Response<AiMessage> response)
            {
                ...
                {
                    com.health.system.domain.AiMessage aiMsg = new com.health.system.domain.AiMessage();
    ...
    {
        List<com.health.system.domain.AiMessage> history = aiChatMapper.selectMessagesByConversationId(conversationId);
        ...
        {
            com.health.system.domain.AiMessage m = history.get(i);
